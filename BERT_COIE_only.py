...
from utils.data_processor_only import InputFeatures, convert_single_example, OreProcessor
...
def create_model(bert_config, is_training, input_ids, input_mask,
                 segment_ids, labels, num_labels, use_one_hot_embeddings):  # 这里是构建模型的重点，需要改变
...
def main(_):
    ...
    run_config = tf.contrib.tpu.RunConfig(
        ...
        master=FLAGS.master,
        model_dir=FLAGS.only_output_dir,
    ...
    if FLAGS.do_train:
        train_file = os.path.join(FLAGS.only_output_dir, "train.tf_record")
    ...
    if FLAGS.do_eval:
        ...
        eval_file = os.path.join(FLAGS.only_output_dir, "eval.tf_record")
        ...
        output_eval_file = os.path.join(FLAGS.only_output_dir, "eval_results.txt")
        ...
        output_predict_file = os.path.join(FLAGS.only_output_dir, "label_test.txt")

    if FLAGS.do_predict:
        token_path = os.path.join(FLAGS.only_output_dir, "token_test.txt")
        ...
        predict_file = os.path.join(FLAGS.only_output_dir, "predict.tf_record")
